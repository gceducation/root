...
public class PickerWinLose {
    ...
    public static void main(String[] args) {
        ...
        if (j == 0) {
            ...
            jTokPickMin = getIntFromConsole(console, jLimitTokPickMin, jTokenCount, "How many minimum tokens to pick per turn ?");
            jTokPickMac = getIntFromConsole(console, jTokPickMin, jTokenCount, "How many maximum tokens to pick per turn ?");
    ...
    private static void playGame(Scanner console, Random rng, int jTokenCount, int jTokPickMin, int jTokPickMac, boolean fHumanFirst, boolean fLastTokenWins) {
            ...
            if (jTokPickMin > jTokRemaining) {
                ...
                if (jPlayerCurrent == 0) {
                    ...
                    if (jTokPickMin == jTokPickMac) {
                        ...
                        jPickedThisTurn = getIntFromConsole(console, jTokPickMin, jTokPickMac, "How many do you want to pick ?");

                    }

                } else {
                    // Computer Move
                    jPickedThisTurn = getComputerMove(console, rng, jTokenCount, jTokPickMin, jTokPickMac, jTokRemaining, fLastTokenWins);
    ...
    private static int getComputerMove(Scanner console, Random rng, int jTokenCount, int jTokPickMin, int jTokPickMac, int jTokRemaining, boolean fLastTokenWins) {
        int jRet = 0;
